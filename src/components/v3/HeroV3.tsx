...
// Reaproveita a cena 3D da V2.
const SceneV2 = dynamic(() => import("@/components/v2/three/SceneV2"), { ssr: false, loading: () => null });
...
export function HeroV3() {
  ...
  return (
    <section id="top" className="relative flex min-h-screen items-center overflow-hidden">
      <div className="bg-grid absolute inset-0 -z-30 opacity-[0.15]" aria-hidden />
      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        <div className="max-w-2xl">
          ...
          {/* Linha de meta com filete vertical */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <p className="font-mono text-sm uppercase tracking-[0.3em] text-muted">{t.hero.greeting}</p>
          </motion.div>
          ...
          <motion.h1
            ...
            className="mt-4 text-5xl font-semibold leading-[1.05] tracking-tight sm:text-7xl md:text-8xl"
          >
